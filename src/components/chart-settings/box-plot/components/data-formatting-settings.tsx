...
import { DataSettings } from "components/chart-settings/box-plot/components/data-formatting-components/data-settings"
import FoldySection from "components/chart-settings/vega-combo/components/widgets/foldy-section"

export const DataFormattingSettings = ({ chartId }: { chartId: string }) => (
  <>
