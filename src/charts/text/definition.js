...
import TextChart from "./text-container"
import TextChartSettings from "./chart-settings"
import getTextChartData from "./getTextChartData"

const textChartDefinition = {
  type: "text",
  typeAlias: "TEXT",
  typeConstant: "TEXT",
  chartDataFormatter: getTextChartData,
  chartTypeCategories: [NOT_BE_RENDERED],
  labelsIcons: { label: "Text", icon: "chart-text" },
  Component: TextChart,
  iconId: "icon-chart-text",
  exportChartData: {
    getChartData: (chart) => chart.text,
  ...
  IconComponent: function TextIconComponent() {
    return (
  ...
  ChartSettingsComponent: TextChartSettings,
  defaultColors: {
    type: "ordinal",
    key: "rainbow",
  ...
  dimensionSettings: {
    ...
    defaultColors: getColors(CHARTS_DEFAULT_COLORS).text,
...
export default textChartDefinition
