...
const DeckGLPointmapSettings: FC = () => {
  ...
  const updateSizeRange = useCallback(
    (range) =>
      dispatch(
        updateChart(chartId, { sizeRange: [range, SIZE_RANGE_DEFAULTS[1]] })
      ),
    [dispatch, chartId]
  )
  ...
  return (
    <div>
      ...
      <div className="chart-editor-section">
        ...
        <CustomSlider
          defaultValue={
            (chart.sizeRange && chart.sizeRange[0]) || SIZE_RANGE_DEFAULTS[0]
          }
          testid={"point-size"}
          max={SIZE_RANGE_MAX}
          min={1}
...
export default DeckGLPointmapSettings
