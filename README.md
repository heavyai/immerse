...
NVIDIA takes security seriously. If you discover a vulnerability in Immerse, **DO NOT open a public issue**. Use one of the private reporting channels described in [SECURITY.md](https://github.com/heavyai/immerse/blob/main/SECURITY.md).
